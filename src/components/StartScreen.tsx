...
export const StartScreen = ({ onStart }: Props) => {
  ...
  return (
    ...
    >
      ...
      {/* Settings & Controls */}
      <div className="w-full bg-white/40 backdrop-blur-2xl p-6 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.12),inset_0_0_20px_rgba(255,255,255,0.42)] border border-white/60 mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
